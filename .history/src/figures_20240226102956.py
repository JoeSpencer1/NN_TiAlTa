...
fig, ax = plt.subplots()
ax.scatter(C30x, C30y, color='blue', marker='s', label='30˚: $||e||_{L_{2}}=50.24h^{2.18}$')
ax.scatter(C45x, C45y, color='red', marker='o', facecolor='none', label='45˚: $||e||_{L_{2}}=46.13h^{2.16}$')
ax.scatter(C60x, C60y, color='green', marker='x', label='60˚: $||e||_{L_{2}}=66.29h^{2.27}$')
ax.scatter(C70x, C70y, color='black', marker='^', label='70.3˚: $$\left\|\|e\right\|\|_{L_{2}}=23.04h^{1.70}$')
...
fig, ax = plt.subplots()
ax.scatter(Blx, Bly, color='blue', marker='s', label='Linear: $||e||_{L_{2}}=5.68h^{1.47}$')
ax.scatter(Bqx, Bqy, color='red', marker='o', facecolor='none', label='Quadratic: $||e||_{L_{2}}=2.16h^{2.16}$')
