...
ax1.errorbar(n, l3Dσ, yerr = εl3Dσ, color = 'yellow', linestyle = '-.',label = "linear 3D mesh")
...
ax2.errorbar(n, l3DE, yerr = εl3DE, color = 'yellow', linestyle = '-.', label = "Room temperature (n$_{tr}$=25)")
