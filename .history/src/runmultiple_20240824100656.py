...
if __name__ == '__main__':
    run_processes(np.array([
        "validation_three('sy', 'TI33_25', 'B3090', 0, 'Lu_Berkovich', 14, 'Lu_conical', 100, typ='hi')",
        "validation_three('sy', 'TI33_25', ('Al6061', 'B3090'), 2, 'Lu_Berkovich', 14, 'Lu_conical', 100, typ='hi')",
        "validation_three('sy', 'TI33_25', ('Al6061', 'B3090'), 20, 'Lu_Berkovich', 14, 'Lu_conical', 100, typ='hi')",
        "validation_three('sy', 'TI33_25', 'B3090', 2, 'Lu_Berkovich', 14, 'Lu_conical', 100, typ='hi')",
        "validation_three('sy', 'TI33_25', 'B3090', 20, 'Lu_Berkovich', 14, 'Lu_conical', 100, typ='hi')"
        ]))
    run_processes(np.array([
        "validation_three('Er', 'TI33_25', 'B3090', 0, 'Lu_Berkovich', 14, 'Lu_conical', 100, typ='hi')",
        "validation_three('Er', 'TI33_25', ('Al6061', 'B3090'), 2, 'Lu_Berkovich', 14, 'Lu_conical', 100, typ='hi')",
        "validation_three('Er', 'TI33_25', ('Al6061', 'B3090'), 20, 'Lu_Berkovich', 14, 'Lu_conical', 100, typ='hi')",
        "validation_three('Er', 'TI33_25', 'B3090', 2, 'Lu_Berkovich', 14, 'Lu_conical', 100, typ='hi')",
        "validation_three('Er', 'TI33_25', 'B3090', 20, 'Lu_Berkovich', 14, 'Lu_conical', 100, typ='hi')"
    ]))
    # run_processes(np.array([
