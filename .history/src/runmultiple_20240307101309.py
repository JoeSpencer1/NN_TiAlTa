...
if __name__ == '__main__':
    ...
    arguments = np.array([
        "validation_one('sigma_y', 0, '2D_70.3', '2D_70.3')",
        "validation_one('sigma_y', 1, '2D_70.3', '2D_70.3')",
        "validation_one('sigma_y', 2, '2D_70.3', '2D_70.3')",
        "validation_one('sigma_y', 3, '2D_70.3', '2D_70.3')",
        "validation_one('sigma_y', 4, '2D_70.3', '2D_70.3')",
        "validation_one('sigma_y', 5, '2D_70.3', '2D_70.3')",
        "validation_one('sigma_y', 6, '2D_70.3', '2D_70.3')",
        "validation_one('sigma_y', 8, '2D_70.3', '2D_70.3')",
        "validation_one('sigma_y', 10, '2D_70.3', '2D_70.3')",
        "validation_one('sigma_y', 15, '2D_70.3', '2D_70.3')",
        "validation_one('sigma_y', 20, '2D_70.3', '2D_70.3')",
        ])
