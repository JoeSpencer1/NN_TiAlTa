...
ax.scatter(C45x, C45y, color='red', marker='o', facecolor='none', label='45˚: $||e||_{L_{2}}=5.87h^{1.95}$')
ax.scatter(C60x, C60y, color='black', marker='x', label='60˚: $||e||_{L_{2}}=11.03h^{1.81}$')
...
ax.scatter(Bqx, Bqy, color='red', marker='o', facecolor='none', label='Quadratic: $||e||_{L_{2}}=0.91h^{2.69}$')
