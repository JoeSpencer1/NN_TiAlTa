...
lu3σ = []
εlu3σ = []
lu3E = [14.3159, 7.1786, 5.7400, 5.0841, 4.7629, 3.5478, 3.5618]
εlu3E = [14.3159-8.8402, 7.1786-5.2799, 5.7400-3.1702, 5.0841-3.5194, 4.7629-2.9743, 3.5478-2.9887, 3.5618-2.4445]
...
ax2.set_yticks([0, 30, 60, 90, 120, 150, 180, 210])
ax2.set_yticklabels([0, 30, 60, 90, 120, 150, 180, 210])
ax2.legend()
ax2.set_ylabel("MAPE (%)")
ax2.set_xlabel("Experimental training data size")
plt.subplots_adjust(bottom=0.180)
