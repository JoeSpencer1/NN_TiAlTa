...
if __name__ == '__main__':
    ...
    arguments = np.array([   
        "validation_exp_cross2('sigma_y', 2, 'B3090a', 'B3090a')",
        "validation_exp_cross2('Estar', 2, 'B3090a', 'B3090a')",
        "validation_exp_cross2('sigma_y', 20, 'B3090a', 'B3090a')",
        "validation_exp_cross2('Estar', 20, 'B3090a', 'B3090a')"        
        ])
