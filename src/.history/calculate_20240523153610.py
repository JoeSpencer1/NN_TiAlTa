...
for i in range(len(df['C (GPa)'])):
    model_old(df['C (GPa)'][i], df['dP/dh (N/m)'][i], df['nu'][i], df['E* (GPa)'][i], df['hmax(um)'][i], df['hr(um)'][i])[0]
    model_old(df['C (GPa)'][i], df['dP/dh (N/m)'][i], df['nu'][i], df['E* (GPa)'][i], df['hmax(um)'][i], df['hr(um)'][i])[1]
    model_new(df['C (GPa)'][i], df['nu'][i], df['E* (GPa)'][i], df['hmax(um)'][i])[0]
    model_new(df['C (GPa)'][i], df['nu'][i], df['E* (GPa)'][i], df['hmax(um)'][i])[1]