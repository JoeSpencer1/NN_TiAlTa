...
rqE = [37.33, 1.2, 30.03, 257.9, 8.33, 2.55, 3.37, 31.51]
εrqE = [47.03, 1.31, 61.95, 295.82, 15.46, 3.56, 2.69, 62.86]
# Rough linear
...
εexpE = [374.75, 82.24, 33.76, 25.67, 5.88, 3, 1.99, 0.64]
# Quad 2
quad2σ = [1059.66, 100.98, 92.71, 30.64, 23.04, 17.84, 21.85, 15.16, 10.92]
εquad2σ = [636.84, 102.66, 104.39, 19.21, 12.42, 6.85, 10.31, 9.01, 9.78]
quad2E = [24.29, 23.16, 10.45, 11.09, 5.52, 5.61, 3.91, 2.93, 1.68]
εquad2E = [10.07, 15.14, 9.92, 7.51, 3.91, 5.65, 3.78, 1.88, 1.21]
# Quad hi
quadσ = [871.38, 263.41, 115.62, 53.59, 59.53, 21.74, 17.79, 9.61, 5.69]
εquadσ = [1226.36, 240.95, 166.55, 29.94, 45.5, 7.92, 7.32, 2.5, 1.69]
quadE = [161.76, 27.14, 35.97, 28.67, 10.65, 13.45, 3.83, 3.23, 0.84]
