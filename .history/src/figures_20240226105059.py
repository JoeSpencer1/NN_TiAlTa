...
''''''
Bqx = [0.5, 0.25, 0.125]
Bqy = [2.249280500074151, 0.4528182068513479, 0.11320455171283705] * 10.0 ** -9
Blx = [0.5, 0.25, 0.125]
Bly = [2.050285444732717, 1.069964747224104, 0.26749118680602585] * 10.0 ** -9
Bfx = [0.01, 1.5]
C30x = [0.1, 0.050, 0.025]
C30y = [0.32887381133679034, 0.06370805207444536, 0.015927013018611345] * 10.0 ** -9
C45x = [0.1, 0.050, 0.025]
C45y = [0.3157380151439883, 0.06281887279533632, 0.01570471819883408] * 10.0 ** -9
C60x = [0.1, 0.050, 0.025]
C60y = [0.35762811470274765, 0.0616597074028916, 0.015414926850722898] * 10.0 ** -9
C70x = [0.1, 0.050, 0.025]
C70y = [0.4621908096792614, 0.17572699330111273, 0.043931748325278266] * 10.0 ** -9
