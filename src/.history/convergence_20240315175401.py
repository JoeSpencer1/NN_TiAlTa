...
print('C=', np.average([e1/maxh**(np.log(e1/e5)/np.log(16)), e2/maxh**(np.log(e1/e5)/np.log(16)), e3/maxh**(np.log(e1/e5)/np.log(16)), e4/maxh**(np.log(e1/e5)/np.log(16)), e5/maxh**(np.log(e1/e5)/np.log(16))]))