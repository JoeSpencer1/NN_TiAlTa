...
if __name__ == '__main__':
    ...
    arguments = np.array([
        "validation_three('Estar', 5, 'B3090', 'B3090', lay=2)",
        "validation_three('Estar', 0, 'B3090', 'B3090', lay=2)",
        "validation_three('Estar', 20, 'B3090', 'B3090', lay=2)",
        "validation_three('sigma_y', 0, 'B3090', 'B3090', lay=2)",
        "validation_three('sigma_y', 5, 'B3090', 'B3090', lay=2)",
        "validation_three('sigma_y', 20, 'B3090', 'B3090', lay=2)",
        ])
