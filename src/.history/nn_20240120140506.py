...
def 
    ...
    for process in processes:
        process.join()
#def simultaneous_nn(train_size, div, dataexp, datatrain, dataBerk, dataFEM, lay=2, wid=128)
...
def validation_two(yname, train_size, exp, low, hi, lay=2, wid=128):
    ...
    if train_size == 0:
        ...
        #_, ape, y = data_portion(train_size, div, dataexp, datatrain, dataBerk, dataFEM, lay=2, wid=128):
