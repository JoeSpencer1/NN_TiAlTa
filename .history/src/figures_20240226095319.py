...
''''''
Bqx = [0.5, 0.25, 0.125]
Bqy = [0.2249280500074151, 0.04528182068513479, 0.011320455171283705]
Blx = [0.5, 0.25, 0.125]
Bly = [0.2050285444732717, 0.1069964747224104, 0.026749118680602585]
Bfx = [0.01, 1.5]
C30x = [0.1, 0.050, 0.025]
C30y = [0.032887381133679034, 0.006370805207444536, 0.0015927013018611345]
C45x = [0.1, 0.050, 0.025]
C45y = [0.03157380151439883, 0.006281887279533632, 0.001570471819883408]
C60x = [0.1, 0.050, 0.025]
C60y = [0.035762811470274765, 0.00616597074028916, 0.0015414926850722898]
