...
ax.scatter(Bqx, Bqy, color='red', marker='^', facecolor='none', label='Qadratic 3D: $||e||_{L_{2}}=(0.19\\times 10^{-3})h^{2.16}$')
ax.scatter(C70lx, C70ly, color='gray', marker='o', label='Linear 2D: $||e||_{L_{2}}=(7.41\\times 10 ^{-3})h^{1.86}$')
...
ax.set_yscale('log')
ax.set_ylim([5*10.0**-12, 0.6*10.0**-8])
ax.grid(False)
