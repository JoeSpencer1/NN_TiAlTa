...
ax.scatter(C70lx, C70ly, color='black', marker='^', label='Linear 2D: $||e||_{L_{2}}=(7.41\\times 10 ^{-3})h^{1.86}$')
ax.scatter(C70qx, C70qy, color='gray', marker='*', label='Qadratic 2D: $||e||_{L_{2}}=(0.11\\times 10^{-3})h^{2.13}$')
ax.plot(Bfx, Bfl, linestyle="--", color='blue')
ax.plot(Bfx, Bfq, linestyle="--", color='red')
ax.plot(C70lx, f70l, linestyle="--", color='black')
ax.plot(C70qx, f70q, linestyle="--", color='gray')
ax.plot()
...
ax.set_yscale('log')
ax.set_ylim([0.05*10.0**-11, 10.0**-9])
ax.grid(False)
