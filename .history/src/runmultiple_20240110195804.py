...
if __name__ == '__main__':
    ...
    arguments = np.array([
        "validation_two('Estar', 1, 'TI33_25', 'Berk', 'Exp', lay=9)",
        "validation_two('Estar', 2, 'TI33_25', 'Berk', 'Exp', lay=9)",
        "validation_two('Estar', 3, 'TI33_25', 'Berk', 'Exp', lay=9)",
        "validation_two('Estar', 4, 'TI33_25', 'Berk', 'Exp', lay=9)",
        "validation_two('Estar', 5, 'TI33_25', 'Berk', 'Exp', lay=9)",
        "validation_two('Estar', 6, 'TI33_25', 'Berk', 'Exp', lay=9)",
        "validation_two('Estar', 8, 'TI33_25', 'Berk', 'Exp', lay=9)",
        "validation_two('Estar', 10, 'TI33_25', 'Berk', 'Exp', lay=9)",
        "validation_two('Estar', 20, 'TI33_25', 'Berk', 'Exp', lay=9)"
        ])
    ...
    for process in processes:
        ...
        '''
        ,
        "validation_two('sigma_y', 1, 'TI33_25', 'Berk', 'Exp', lay=9)",
        "validation_two('sigma_y', 2, 'TI33_25', 'Berk', 'Exp', lay=9)",
        "validation_two('sigma_y', 3, 'TI33_25', 'Berk', 'Exp', lay=9)",
        "validation_two('sigma_y', 4, 'TI33_25', 'Berk', 'Exp', lay=9)",
        "validation_two('sigma_y', 5, 'TI33_25', 'Berk', 'Exp', lay=9)",
        "validation_two('sigma_y', 6, 'TI33_25', 'Berk', 'Exp', lay=9)",
        "validation_two('sigma_y', 8, 'TI33_25', 'Berk', 'Exp', lay=9)",
        "validation_two('sigma_y', 10, 'TI33_25', 'Berk', 'Exp', lay=9)",
        "validation_two('sigma_y', 20, 'TI33_25', 'Berk', 'Exp', lay=9)"
        '''
