...
ax1.errorbar(n_me, meσ, yerr = εmeσ, color = 'red', label = "My replication (70.3˚)")
ax1.set_yscale('linear')
ax1.set_ylim([0, 150])
ax1.set_xlim([-0.5, 90])
...
ax2.errorbar(n_me, meE, yerr = εmeE, color = 'red', label = "My replication (n$_{tr}$=100)")
ax2.set_yscale('linear')
ax2.set_ylim([0, 16])
ax2.set_xlim([-0.5, 90])
...
# Lu's data, digitized fig. 2 from paper
n_Br = [3, 6, 9, 12]
Brσ = [398.29105, 213.71378, 136.55495, 82.90755]
εBrσ = [391.62503, 266.88892, 160.28539, 87.47421]
BrE = [130.84723, 39.478073, 13.386026, 9.985954]
εBrE = [88.05579, 46.16688, 9.003432, 9.146125]

fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(12, 5))
ax1.errorbar(n_Br, Brσ, yerr = εBrσ, color = 'green', label = "Lu's 3D FEM data")
ax1.set_yscale('linear')
ax1.set_ylim([0, 500])
ax1.set_xlim([-0.5, 15])
...
ax2.errorbar(n_Br, BrE, yerr = εBrE, color = 'green', label = "Lu's data (n$_{tr}$=14)")
ax2.set_yscale('linear')
ax2.set_ylim([0, 150])
ax2.set_xlim([-0.5, 15])
...
# Lu's data, digitized fig. 2 from paper
n_Ex = [3, 6, 9, 12]
Exσ = [398.29105, 213.71378, 136.55495, 82.90755]
εExσ = [391.62503, 266.88892, 160.28539, 87.47421]
ExE = [130.84723, 39.478073, 13.386026, 9.985954]
εExE = [88.05579, 46.16688, 9.003432, 9.146125]

fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(12, 5))
ax1.errorbar(n_Ex, Exσ, yerr = εExσ, color = 'green', label = "Lu's 3D FEM data")
ax1.set_yscale('linear')
ax1.set_ylim([0, 500])
ax1.set_xlim([-0.5, 15])
ax1.set_xticks([0, 3, 6, 9, 12, 15])
...
ax2.errorbar(n_Ex, ExE, yerr = εExE, color = 'green', label = "Lu's data (n$_{tr}$=14)")
ax2.set_yscale('linear')
ax2.set_ylim([0, 150])
ax2.set_xlim([-0.5, 15])
ax2.set_xticks([0, 3, 6, 9, 12, 15])
