...
fig, ax = plt.subplots()
ax.scatter(Blx, Bly, color='blue', marker='s', label='Linear 3D: $||e||_{L_{2}}=0.0031h^{1.71}$')
ax.scatter(Bqx, Bqy, color='red', marker='^', label='Qadratic 3D: $||e||_{L_{2}}=0.0177h^{2.19}$')
ax.scatter(C70lx, C70ly, color='gray', marker='o', facecolor='none', label='Linear 2D: $||e||_{L_{2}}=0.0194h^{1.82}$')
ax.scatter(C70qx, C70qy, color='violet', marker='d', facecolor='none', label='Qadratic 2D: $||e||_{L_{2}}=0.0197h^{1.95}$')
