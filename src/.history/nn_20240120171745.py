...
def multiple_NN(train_size, div, dataexp, datatrain, dataBerk, dataFEM, lay=2, wid=128):
    arg = "data_portion(" + str(train_size) + "," + str(div) + "," + dataexp + "," + datatrain + "," + dataBerk + "," + dataFEM + ",lay=" + lay + ",wid=" + wid + ")"
    arguments = np.array([])
    for i in div * 4:
...
def validation_three(yname, train_size, train, exp, lay=2, wid=128):
    ...
    if train_size == 0:
        ...
        yG = []
        div = 10
        multiple_NN(train_size, div, dataexp, datatrain, dataBerk, dataFEM, lay, wid)
        '''
