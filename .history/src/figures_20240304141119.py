...
ax1.errorbar(n_3Dq, q3Dσ, yerr = εq3Dσ, color = 'orange', linestyle = '--',label = "Experimental data")
ax1.set_yscale('log')
ax1.set_ylim([1, 1000])
ax1.set_xlim([-0.5, 21])
ax1.set_xticks([0, 5, 10, 15, 20])
...
ax1.errorbar(n_3Dq, q3DE, yerr = εq3DE, color = 'orange', linestyle = '--',label = "Experimental data")
ax2.set_yscale('log')
ax2.set_ylim([0, 200])
ax2.set_xlim([-0.5, 21])
ax2.set_xticks([0, 5, 10, 15, 20])
