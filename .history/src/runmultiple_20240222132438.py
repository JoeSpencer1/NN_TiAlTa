...
if __name__ == '__main__':
    ...
    arguments = np.array([  
        "validation_exp_cross2('sigma_y', 0, 'FEM_70deg', 'Berkovich', 'B3090', 'B3090')",
        "validation_exp_cross2('Estar', 0, 'FEM_70deg', 'Berkovich', 'B3090', 'B3090')",
        "validation_exp_cross2('sigma_y', 1, 'FEM_70deg', 'Berkovich', 'B3090', 'B3090')",
        "validation_exp_cross2('Estar', 1, 'FEM_70deg', 'Berkovich', 'B3090', 'B3090')",
        "validation_exp_cross2('sigma_y', 20, 'FEM_70deg', 'Berkovich', 'B3090', 'B3090')",
        "validation_exp_cross2('Estar', 20, 'FEM_70deg', 'Berkovich', 'B3090', 'B3090')" 
        ])
