...
''''''
Bqx = [0.5, 0.25, 0.125]
Bqy = [2.249280500074151*10.0**-9, 0.4528182068513479*10.0**-9, 0.11320455171283705*10.0**-9]
Blx = [0.5, 0.25, 0.125]
Bly = [2.050285444732717*10.0**-9, 1.069964747224104*10.0**-9, 0.26749118680602585*10.0**-9]
Bfx = [0.01, 1.5]
C30x = [0.1, 0.050, 0.025]
C30y = [0.32887381133679034*10.0**-9, 0.06370805207444536*10.0**-9, 0.015927013018611345*10.0**-9]
C45x = [0.1, 0.050, 0.025]
C45y = [0.3157380151439883*10.0**-9, 0.06281887279533632*10.0**-9, 0.01570471819883408*10.0**-9]
C60x = [0.1, 0.050, 0.025]
C60y = [0.35762811470274765*10.0**-9, 0.0616597074028916*10.0**-9, 0.015414926850722898*10.0**-9]
C70x = [0.1, 0.050, 0.025]
C70y = [0.4621908096792614*10.0**-9, 0.17572699330111273*10.0**-9, 0.043931748325278266*10.0**-9]
...
fig, ax = plt.subplots()
ax.scatter(C30x, C30y, color='blue', marker='s', label='30˚: $||e||_{L_{2}}=(50.24\\times 10 ^{-9})h^{2.18}$')
ax.scatter(C45x, C45y, color='red', marker='o', facecolor='none', label='45˚: $||e||_{L_{2}}=(46.13\\times 10 ^{-9})h^{2.16}$')
ax.scatter(C60x, C60y, color='green', marker='x', label='60˚: $||e||_{L_{2}}=(66.29\\times 10 ^{-9})h^{2.27}$')
ax.scatter(C70x, C70y, color='black', marker='^', label='70.3˚: $||e||_{L_{2}}=(23.04\\times 10 ^{-9})h^{1.70}$')
...
ax.set_yscale('log')
ax.set_ylim([0.005*10.0**-9, 1*10.0**-9])
ax.grid(False)
...
fig, ax = plt.subplots()
ax.scatter(Blx, Bly, color='blue', marker='s', label='Linear: $||e||_{L_{2}}=(5.68\\times 10 ^{-9})h^{1.47}$')
ax.scatter(Bqx, Bqy, color='red', marker='o', facecolor='none', label='Quadratic: $||e||_{L_{2}}=(2.16\\times 10 ^{-9})h^{2.16}$')
...
ax.set_ylabel('L$_{2}$ error')
ax.set_yscale('log')
ax.set_ylim([0.08*10.0**-9, 5*10.0**-9])
ax.grid(False)
leg = ax.legend(loc='lower right')
