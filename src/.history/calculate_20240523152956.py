...
df['sy1'], df['n1'], df['sy2'], df['n2'] = df['C (GPa)']
for i in range(len(df['C (GPa)'])):
    df['sy1'][i] = model_old(df['C (GPa)'][i], df['dP/dh (N/m)'][i], df['nu'][i], df['E* (GPa)'][i], df['hmax(um)'][i], df['hr(um)'][i])[0]
    df['n1'][i] = model_old(df['C (GPa)'][i], df['dP/dh (N/m)'][i], df['nu'][i], df['E* (GPa)'][i], df['hmax(um)'][i], df['hr(um)'][i])[1]
    df['sy2'] = model_new(df['C (GPa)'][i], df['nu'][i], df['E* (GPa)'][i], df['hmax(um)'][i])[0]
    df['n2'] = model_new(df['C (GPa)'][i], df['nu'][i], df['E* (GPa)'][i], df['hmax(um)'][i])[1]