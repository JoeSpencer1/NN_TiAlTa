...
# Define a variable
my_variable = ("apple", "banana", "cherry")

# Check if the variable is a tuple
if type(my_variable) is tuple:
    print("my_variable is a tuple")
elif type(my_variable) is str:
    print("my_variable is a string")
else:
    print("my_variable is neither a tuple nor a string")
