...
ax1.errorbar(s_x, s_σ, yerr = εs_σ, color = 'red', label = "3D FEM (n$_{tr}$=26)")
ax1.errorbar(n_70, c70σ, yerr = εc70σ, color = 'orange', label = "70.3˚ 2D FEM (n$_{tr}$=58)")
ax1.set_yscale('linear')
ax1.set_ylim([0, 120])
ax1.set_xlim([-0.5, 41])
ax1.set_xticks([0, 10, 20, 30, 40])
...
ax2.errorbar(s_x, s_E, yerr = εs_E, color = 'red', label = "3D FEM")
ax2.errorbar(n_70, c70E, yerr = εc70E, color = 'orange', label = "2D FEM")
ax2.set_yscale('linear')
ax2.set_ylim([0, 12])
ax2.set_xlim([-0.5, 41])
ax2.set_xticks([0, 10, 20, 30, 40])
