...
ax2.errorbar(ex_x, ex_E, yerr = εex_E, color = 'blue', label = "30˚")
ax2.errorbar(s_x, s_E, yerr = εs_E, color = 'green', label = "60˚")
ax2.errorbar(n_70, c70E, yerr = εc70E, color = 'gray', label = "70.3˚")
ax2.set_yscale('linear')
ax2.set_ylim([0, 12])
ax2.set_xlim([-0.5, 41])
ax2.set_xticks([0, 10, 20, 30, 40])
