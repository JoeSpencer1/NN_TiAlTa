...
if __name__ == '__main__':
    run_processes(np.array([
        ...
        "validation_three('sigma_y', 'TI33_25', 'TI33_25', 5, '3D_quad', 5, '2D_70_quad', 5, typ='lo', n_vd=0)",
        "validation_three('sigma_y', 'TI33_25', 'TI33_25', 15, '3D_quad', 15, '2D_70_quad', 15, typ='lo', n_vd=0)"
        ]))
    '''
    run_processes(np.array([
