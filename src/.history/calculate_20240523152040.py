...
df['sy1'] = print(model_new(df['C (GPa)'][15], df['dP/dh (N/m)'][15], df['nu'][15], df['E* (GPa)'][15], df['hmax(um)'][15], df['hr(um)'][15]))
df['sy1'] = print(model_old(df['C (GPa)'][15], df['dP/dh (N/m)'][15], df['nu'][15], df['E* (GPa)'][15], df['hmax(um)'][15], df['hr(um)'][15]))