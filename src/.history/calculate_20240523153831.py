...
df['sy2'] = df['C (GPa)']
df['n2'] = df['C (GPa)']
print(model_old(df['C (GPa)'][i], df['dP/dh (N/m)'][i], df['nu'][i], df['E* (GPa)'][i], df['hmax(um)'][i], df['hr(um)'][i]))
print(model_new(df['C (GPa)'][i], df['nu'][i], df['E* (GPa)'][i], df['hmax(um)'][i]))
for i in range(len(df['C (GPa)'])):
    model_old(df['C (GPa)'][i], df['dP/dh (N/m)'][i], df['nu'][i], df['E* (GPa)'][i], df['hmax(um)'][i], df['hr(um)'][i])
    model_new(df['C (GPa)'][i], df['nu'][i], df['E* (GPa)'][i], df['hmax(um)'][i])