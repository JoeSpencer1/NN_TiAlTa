...
rqE = [94.03, 126.64, 0.73, 22.15, 7.69, 3.32, 9.4, 8.25]
εrqE = [136.66, 326.68, 0.52, 20.6, 11.09, 2.76, 7.94, 7.18]
# Rough linear
...
# Quad
quadσ = [712.18, 1351.81, 452.26, 319.8, 177.61, 60.14, 46.42, 23.17, 15.56, 10.5]
εquadσ = [182.51, 1072.1, 511.24, 442.56, 310.37, 44.82, 19.6, 12.36, 7.49, 8.69]
quadE = [363, 51.58, 63.66, 79.89, 32.66, 11.93, 19.23, 9.25, 3.03, 0.99]
εquadE = [30.26, 17.24, 45.07, 93.41, 21.8, 7.54, 29.84, 10.76, 1.95, 1.56]
# Linear
linσ = [392.32, 36634.57, 708.92, 137.15, 59.39, 58.04, 49.06, 34.95, 7.95, 2.26]
εlinσ = [148.21, 65961.55, 1199.85, 151.5, 50.03, 52.52, 50.9, 29.06, 4.53, 1.28]
linE = [75.04, 491.49, 337.55, 76.81, 11.18, 12.07, 5.32, 2.32, 1.31, 0.71]
εlinE = [17.95, 1047.59, 575.56, 97.39, 8.19, 15.69, 3.57, 1.41, 1.12, 0.46]
# Rough quadratic
rqσ = [302.54, 973.17, 187.86, 98.51, 44.6, 23.13, 18.43, 13.11, 12.45, 3.17]
εrqσ = [155, 913.21, 196.17, 128.93, 30.89, 12.48, 8.19, 5.92, 4, 1.26]
rqE = [171.84, 726.8, 53.62, 35.26, 13.62, 4.73, 2.79, 2.13, 1.23, 0.78]
εrqE = [32.78, 1996.38, 42.36, 50.84, 24.58, 2.59, 1.87, 1.73, 0.67, 0.27]
# Rough linear
rlσ = [389.23, 2657.76, 66.44, 49.1, 34.98, 14.36, 7.57, 5.19, 3.86, 1.75]
εrlσ = [178.88, 3730.08, 57.76, 60.19, 50.49, 8.66, 3.09, 4.66, 1.1, 1.06]
rlE = [52.66, 178.95, 35.97, 11.05, 6, 4.32, 3.64, 1.88, 1.39, 0.4]
εrlE = [13.35, 435.57, 45.93, 13.19, 7.08, 1.71, 2.71, 1.18, 1.11, 0.26]
...
n = [0, 1,2, 3, 4, 5, 6, 8, 10, 15]
# Quad
quadσ = [591.18, 36184.53, 1259.9, 419, 320.04, 189.93, 121.16, 71.58, 51.27, 31.79]
εquadσ = [109.85, 66423.99, 1123.25, 312.95, 146.28, 113.76, 77.07, 29.23, 20.34, 23.96]
quadE = [297.1, 497.91, 723.59, 96.18, 58.12, 15.87, 18.86, 9.63, 7.99, 3.19]
εquadE = [36.07, 922.43, 1414.97, 114.58, 62.2, 8.22, 12.32, 9.22, 3.78, 1.92]
# Linear
linσ = [1434.28, 16184.69, 1381.04, 179.68, 136.8, 151.56, 62.47, 53.22, 23.73, 10.51]
εlinσ = [331.04, 30905.79, 2243.39, 179.2, 172.37, 181.03, 35.03, 75.49, 16.61, 8.74]
linE = [290.42, 147.68, 759.69, 73.81, 26.48, 8.68, 10.53, 2.84, 2.46, 1.19]
εlinE = [26.39, 156.24, 945.02, 125.1, 36.81, 5.57, 7.8, 1.02, 1.68, 1.36]
# Rough quadratic
rqσ = [178.76, 4407.64, 27.54, 11.08, 5.63, 2.84, 2.4, 1.58, 0.85, 0.73]
εrqσ = [54.93, 4114.03, 18.8, 6.5, 5.16, 1.3, 1.43, 0.74, 0.36, 0.5]
rqE = [40.73, 48.95, 6.7, 3.21, 1.34, 0.5, 0.68, 0.26, 0.13, 0.09]
εrqE = [11.15, 32.54, 8.89, 2.61, 1.16, 0.35, 0.64, 0.18, 0.06, 0.06]
# Rough linear
rlσ = [86.71, 29777.51, 19.85, 10.27, 3.22, 2.81, 2.78, 1.37, 1.12, 0.71]
εrlσ = [33.18, 82262.28, 15.44, 14.15, 1.68, 1.1, 3.19, 0.84, 0.77, 0.64]
rlE = [19.29, 60.04, 5, 1.91, 0.38, 0.44, 0.2, 0.14, 0.09, 0.06]
εrlE = [7.26, 103.93, 5.09, 2.1, 0.17, 0.41, 0.11, 0.1, 0.05, 0.02]
