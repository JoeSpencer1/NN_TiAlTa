...
for i in range(len(df['C (GPa)'])):
    df.loc['sy1'][i] = model_old(df['C (GPa)'][i], df['dP/dh (N/m)'][i], df['nu'][i], df['E* (GPa)'][i], df['hmax(um)'][i], df['hr(um)'][i])[0]
    df.loc['n1'][i] = model_old(df['C (GPa)'][i], df['dP/dh (N/m)'][i], df['nu'][i], df['E* (GPa)'][i], df['hmax(um)'][i], df['hr(um)'][i])[1]
    df.loc['sy2'][i] = model_new(df['C (GPa)'][i], df['nu'][i], df['E* (GPa)'][i], df['hmax(um)'][i])[0]
    df.loc['n2'][i] = model_new(df['C (GPa)'][i], df['nu'][i], df['E* (GPa)'][i], df['hmax(um)'][i])[1]