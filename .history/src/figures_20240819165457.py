...
ax.scatter(df['disp_y_3D']*1e9, df['react_y_3D']*6e9, color='blue', marker='.', zorder=2, label='3D model')
...
ax.scatter(df['disp_y_2D']*1e9, df['react_y_2D']*1e9, color='red', marker='*', zorder=3, s = 10, label='2D model')
