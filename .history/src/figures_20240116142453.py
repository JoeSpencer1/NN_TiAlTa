...
FEAExpσ = [30.692963398804512, 17.966434316750032, 20.30981467660651]
εFEAExpσ = [24.432717466772974, 17.157632184190486, 15.24454689795884]
FEAExpE = [3.1407760620117187, 0.8857396979081005, 0.48970565795898435]
εFEAExpE = [2.1787414072193108, 0.20985072884833247, 0.24028577974579077]
...
fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(12, 5))
ax1.errorbar(n, threeσ, yerr = εthreeσ, color = 'blue', label = "25˚C")
...
ax2.errorbar(n, threeE, yerr = εthreeE, color = 'blue', label = "25˚C")
