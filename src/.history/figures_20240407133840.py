...
ax1.errorbar(n, linσ, yerr = εlinσ, color = 'darkorange', linestyle = '--', label = "NN, linear 3D FEM training data")
ax1.errorbar(n, rqσ, yerr = εrqσ, color = 'red', linestyle = '-.', label = "NN, rough quadratic 3D FEM training data")
ax1.errorbar(n, rlσ, yerr = εrlσ, color = 'green', linestyle = ':', label = "NN, rough linear 3D FEM training data")
ax1.set_yscale('log')
...
ax2.set_xlim([-0.5, 16])
ax2.set_xticks([0, 5, 10, 15])
ax2.set_yticks([1, 3, 10, 100, 400])
ax2.set_yticklabels([1, 3, 10, 100, 400])
ax2.legend()
ax2.set_ylabel("MAPE (%)")
...
ax1.set_yticklabels([1, 3, 10, 100, 1000])
ax1.legend()
ax1.set_ylabel("MAPE (%)")
