...
if __name__ == '__main__':
    ...
    arguments = np.array([
        "validation_one('Er', 10, 'FEM_70deg', 'FEM_70deg')",
        "validation_one('sigma_y', 10, 'FEM_70deg', 'FEM_70deg')",
        "validation_one('Er', 20, 'FEM_70deg', 'FEM_70deg')",
        "validation_one('sigma_y', 20, 'FEM_70deg', 'FEM_70deg')",
        "validation_one('Er', 30, 'FEM_70deg', 'FEM_70deg')",
        "validation_one('sigma_y', 30, 'FEM_70deg', 'FEM_70deg')",
        "validation_one('Er', 40, 'FEM_70deg', 'FEM_70deg')",
        "validation_one('sigma_y', 40, 'FEM_70deg', 'FEM_70deg')",
        "validation_one('Er', 50, 'FEM_70deg', 'FEM_70deg')",
        "validation_one('sigma_y', 50, 'FEM_70deg', 'FEM_70deg')"
        ])
