...
fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(12, 5))
ax1.errorbar(n, expσ, yerr = εexpσ, color = 'green', label = "MINN with 33% TiAlTa")
ax1.errorbar(n, expσ, yerr = εexpσ, color = 'red', linestyle = '--', label = "MINN with 33% TiAlTa")
ax1.errorbar(n, expσ, yerr = εexpσ, color = 'yellow', linestyle = '-.',label = "MINN with 33% TiAlTa")
ax1.errorbar(n, expσ, yerr = εexpσ, color = 'blue', linestyle = ':',label = "MINN with 33% TiAlTa")
ax1.set_yscale('linear')
ax1.set_ylim([1, 120])
ax1.set_xlim([-0.5, 21])
ax1.set_xticks([0, 5, 10, 15, 20])
...
ax2.errorbar(n, expE, yerr = εexpE, color = 'red', linestyle = '--', label = "Room temperature (n$_{tr}$=25)")
ax2.errorbar(n, expE, yerr = εexpE, color = 'yellow', linestyle = '-.', label = "Room temperature (n$_{tr}$=25)")
ax2.errorbar(n, expE, yerr = εexpE, color = 'blue', linestyle = ':', label = "Room temperature (n$_{tr}$=25)")
ax2.set_yscale('linear')
ax2.set_ylim([0, 20])
ax2.set_xlim([-0.5, 21])
ax2.set_xticks([0, 5, 10, 15, 20])
