...
ax1.errorbar(n, roughσ, yerr = εroughσ, color = 'darkred', linestyle = '-.', label = "MAPE with rough 3D FEM training data")
ax1.set_yscale('log')
...
ax2.errorbar(n, roughE, yerr = εroughE, color = 'darkred', linestyle = '-.')
ax2.set_yscale('log')
...
ax1.errorbar(n, roughσ, yerr = εroughσ, color = 'darkred', linestyle = '-.', label = "MAPE with rough 2D FEM training data")
ax1.set_yscale('log')
ax1.set_ylim([1, 2000])
ax1.set_xlim([-0.5, 16])
ax1.set_xticks([0, 5, 10, 15])
