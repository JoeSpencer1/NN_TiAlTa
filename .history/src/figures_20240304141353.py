...
fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(12, 5))
ax1.errorbar(n_exp, expσ, yerr = εexpσ, color = 'green', label = "Experimental data")
ax1.errorbar(n_3Dq, q3Dσ, yerr = εq3Dσ, color = 'orange', linestyle = '--',label = "Quadratic 3D mesh")
ax1.errorbar(n_3Dl, l3Dσ, yerr = εl3Dσ, color = 'red', linestyle = ':',label = "Linear 3D mesh")
ax1.set_yscale('log')
ax1.set_ylim([1, 1000])
ax1.set_xlim([-0.5, 21])
ax1.set_xticks([0, 5, 10, 15, 20])
...
ax2.errorbar(n_exp, expE, yerr = εexpE, color = 'green', label = "Experimental data")
ax2.errorbar(n_3Dq, q3DE, yerr = εq3DE, color = 'orange', linestyle = '--',label = "Quadratic 3D mesh")
ax2.errorbar(n_3Dl, l3DE, yerr = εl3DE, color = 'red', linestyle = ':',label = "Linear 3D mesh")
ax2.set_yscale('log')
ax2.set_ylim([0, 200])
ax2.set_xlim([-0.5, 21])
ax2.set_xticks([0, 5, 10, 15, 20])
