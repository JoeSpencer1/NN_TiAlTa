...
fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(12, 5))
ax1.errorbar(n, quadσ, yerr = εquadσ, color = 'blue', label = "MAPE with quadratic FEM training data")
ax1.errorbar(n, linσ, yerr = εlinσ, color = 'darkorange', linestyle = '--', label = "MAPE with linear FEM training data")
ax1.errorbar(n, roughσ, yerr = εroughσ, color = 'darkred', linestyle = '-.', label = "MAPE with rough FEM training data")
ax1.set_yscale('log')
ax1.set_ylim([1, 3000])
ax1.set_xlim([-0.5, 16])
ax1.set_xticks([0, 5, 10, 15])
