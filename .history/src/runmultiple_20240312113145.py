...
if __name__ == '__main__':
    ...
    arguments = np.array([
        "validation_one('Er', '2D_70', '2D_70', 10)",
        "validation_one('sigma_y', '2D_70', '2D_70', 10)",
        "validation_one('Er', '2D_70_rough', '2D_70_rough', 10)",
        "validation_one('sigma_y', '2D_70_rough', '2D_70_rough', 10)"
        ])
