...
if __name__ == '__main__':
    ...
    arguments = np.array([
        "validation_two('Er', 'TI33_25', 'TI33_25', 10, '3D_quad', 5, v_lo=0)",
        "validation_two('sigma_y', 'TI33_25', 'TI33_25', 10, '3D_quad', 5, v_lo=0)",
        "validation_two('Er', 'TI33_25', 'TI33_25', 10, '3D_linear', 5, v_lo=0)",
        "validation_two('sigma_y', 'TI33_25', 'TI33_25', 10, '3D_linear', 5, v_lo=0)"
        ])
