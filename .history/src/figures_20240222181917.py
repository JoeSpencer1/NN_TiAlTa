...
ax2.errorbar(n_lub, luFEME, yerr = εluFEME, color = 'green', label = "Lu's data (n$_{tr}$=100)")
ax2.set_yscale('log')
ax2.set_ylim([0, 20])
ax2.set_xlim([-0.5, 21])
ax2.set_xticks([0, 5, 10, 15, 20])
...
fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(12, 5))
ax1.errorbar(n_luc, luFEMσ, yerr = εluFEMσ, color = 'green', label = "Lu's indentations on B3090")
ax1.set_yscale('log')
ax1.set_ylim([1, 120])
ax1.set_xlim([-0.5, 21])
ax1.set_xticks([0, 5, 10, 15, 20])
...
ax2.errorbar(n_luc, luFEME, yerr = εluFEME, color = 'green', label = "Lu's data (n$_{tr}$=100)")
ax2.set_yscale('log')
ax2.set_ylim([0, 20])
ax2.set_xlim([-0.5, 21])
ax2.set_xticks([0, 5, 10, 15, 20])
