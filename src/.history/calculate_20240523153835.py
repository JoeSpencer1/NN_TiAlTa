...
df['sy2'] = df['C (GPa)']
df['n2'] = df['C (GPa)']
print(model_old(df['C (GPa)'][0], df['dP/dh (N/m)'][0], df['nu'][0], df['E* (GPa)'][0], df['hmax(um)'][0], df['hr(um)'][0]))
print(model_new(df['C (GPa)'][0], df['nu'][0], df['E* (GPa)'][0], df['hmax(um)'][0]))
for i in range(len(df['C (GPa)'])):
    model_old(df['C (GPa)'][0], df['dP/dh (N/m)'][0], df['nu'][0], df['E* (GPa)'][0], df['hmax(um)'][0], df['hr(um)'][0])
    model_new(df['C (GPa)'][0], df['nu'][0], df['E* (GPa)'][0], df['hmax(um)'][0])