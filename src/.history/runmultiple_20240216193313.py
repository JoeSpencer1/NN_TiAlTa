...
if __name__ == '__main__':
    ...
    arguments = np.array([
        "validation_mf('sigma_y', 2, 'FEM_70deg', 'Berkovich')",
        "validation_mf('Estar', 2, 'FEM_70deg', 'Berkovich')",
        "validation_mf('sigma_y', 4, 'FEM_70deg', 'Berkovich')",
        "validation_mf('Estar', 4, 'FEM_70deg', 'Berkovich')",
        "validation_mf('sigma_y', 6, 'FEM_70deg', 'Berkovich')",
        "validation_mf('Estar', 6, 'FEM_70deg', 'Berkovich')",
        "validation_mf('sigma_y', 8, 'FEM_70deg', 'Berkovich')",
        "validation_mf('Estar', 8, 'FEM_70deg', 'Berkovich')",
        "validation_mf('sigma_y', 10, 'FEM_70deg', 'Berkovich')",
        "validation_mf('Estar', 10, 'FEM_70deg', 'Berkovich')",
        "validation_mf('sigma_y', 12, 'FEM_70deg', 'Berkovich')",
        "validation_mf('Estar', 12, 'FEM_70deg', 'Berkovich')"
        ])
