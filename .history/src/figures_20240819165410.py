...
ax.scatter(df['disp_y_3D']*1000000, df['react_y_3D']*6000000, color='blue', marker='.', zorder=2, label='3D model')
...
ax.scatter(df['disp_y_2D']*1000000, df['react_y_2D']*1000000, color='red', marker='*', zorder=3, s = 10, label='2D model')
