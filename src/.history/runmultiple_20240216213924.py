...
if __name__ == '__main__':
    ...
    arguments = np.array([
        "validation_FEM('sigma_y', 'Berkovich', 'Berkovich', 2)",
        "validation_FEM('Estar', 'Berkovich', 'Berkovich', 2)",
        "validation_FEM('sigma_y', 'Berkovich', 'Berkovich', 4)",
        "validation_FEM('Estar', 'Berkovich', 'Berkovich', 4)",
        "validation_FEM('sigma_y', 'Berkovich', 'Berkovich', 6)",
        "validation_FEM('Estar', 'Berkovich', 'Berkovich', 6)",
        "validation_FEM('sigma_y', 'Berkovich', 'Berkovich', 8)",
        "validation_FEM('Estar', 'Berkovich', 'Berkovich', 8)",
        "validation_FEM('sigma_y', 'Berkovich', 'Berkovich', 10)",
        "validation_FEM('Estar', 'Berkovich', 'Berkovich', 10)",
