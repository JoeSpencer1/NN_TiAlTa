...
def validation_two(yname, trname, tstname, type, train_size, lay=9, wid=32, angles=[]):
    ...
    if train_size[0] == 80:
        ...
        kf = ShuffleSplit(
            n_splits=10, test_size=len(data.X) - train_size[0], random_state=0
        )
