...
if __name__ == '__main__':
    ...
    arguments = np.array([
        "validation_one('Er', '3D_quad', '3D_quad', 5, v_lo=0)",
        "validation_one('sigma_y', '3D_quad', '3D_quad', 5, v_lo=0)",
        "validation_one('Er', '3D_linear', '3D_linear', 5, v_lo=0)",
        "validation_one('sigma_y', '3D_linear', '3D_linear', 5, v_lo=0)"
        ])
