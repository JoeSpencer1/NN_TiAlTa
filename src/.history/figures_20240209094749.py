...
fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(12, 5))
ax1.errorbar(n_30, c30σ, yerr = εc30σ, color = 'blue', label = "30˚ (n_{tr}=58)")
ax1.errorbar(n_45, c45σ, yerr = εc45σ, color = 'green', label = "45˚ (n_{tr}=58)")
ax1.errorbar(n_60, c60σ, yerr = εc60σ, color = 'grey', label = "60˚ (n_{tr}=58)")
ax1.errorbar(n_70, c70σ, yerr = εc70σ, color = 'red', label = "70.3˚ (n_{tr}=58)")
ax1.set_yscale('linear')
ax1.set_ylim([0, 120])
ax1.set_xlim([-0.5, 41])
...
fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(12, 5))
ax1.errorbar(n_30, c30σ, yerr = εc30σ, color = 'blue', label = "30˚ (n_{tr} = 58)")
ax1.errorbar(n_45, c45σ, yerr = εc45σ, color = 'green', label = "45˚")
ax1.errorbar(n_60, c60σ, yerr = εc60σ, color = 'grey', label = "60˚")
ax1.errorbar(n_70, c70σ, yerr = εc70σ, color = 'red', label = "70.3˚")
ax1.set_yscale('linear')
ax1.set_ylim([0, 120])
ax1.set_xlim([-0.5, 41])
ax1.set_xticks([0, 10, 20, 30, 40])
