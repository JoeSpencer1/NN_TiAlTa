...
for i in range(len(df['C (GPa)'])):
    df.loc[i, 'sy1'] = model_old(df['C (GPa)'][i], df['dP/dh (N/m)'][i], df['nu'][i], df['E* (GPa)'][i], df['hmax(um)'][i], df['hr(um)'][i])[0]
    df.loc[i, 'n1'] = model_old(df['C (GPa)'][i], df['dP/dh (N/m)'][i], df['nu'][i], df['E* (GPa)'][i], df['hmax(um)'][i], df['hr(um)'][i])[1]
    df.loc[i, 'sy2'] = model_new(df['C (GPa)'][i], df['nu'][i], df['E* (GPa)'][i], df['hmax(um)'][i])[0]
    df.loc[i, 'n2'] = model_new(df['C (GPa)'][i], df['nu'][i], df['E* (GPa)'][i], df['hmax(um)'][i])[1]