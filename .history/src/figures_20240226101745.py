...
''''''
Bqx = [0.5, 0.25, 0.125]
Bqy = [2.249280500074151, 0.4528182068513479, 0.11320455171283705]
Blx = [0.5, 0.25, 0.125]
Bly = [2.050285444732717, 1.069964747224104, 0.26749118680602585]
Bfx = [0.01, 1.5]
C30x = [0.1, 0.050, 0.025]
C30y = [0.32887381133679034, 0.06370805207444536, 0.015927013018611345]
C45x = [0.1, 0.050, 0.025]
C45y = [0.3157380151439883, 0.06281887279533632, 0.01570471819883408]
C60x = [0.1, 0.050, 0.025]
C60y = [0.35762811470274765, 0.0616597074028916, 0.015414926850722898]
C70x = [0.1, 0.050, 0.025]
C70y = [0.4621908096792614, 0.17572699330111273, 0.043931748325278266]
...
fig, ax = plt.subplots()
ax.scatter(C30x, C30y, color='blue', marker='s', label='30˚: $\lVert e\\rVert_{L_{2}}=2.30h^{2.183}$')
ax.scatter(C45x, C45y, color='red', marker='o', facecolor='none', label='45˚: $\lVert e\rVert_{L_{2}}=14.42h^{2.40}$')
ax.scatter(C60x, C60y, color='green', marker='x', label='60˚: $\lVert e\\rVert_{L_{2}}=9.60h^{1.95}$')
ax.scatter(C70x, C70y, color='black', marker='^', label='70.3˚: $\lVert e\\rVert_{L_{2}}=9.60h^{1.95}$')
...
fig, ax = plt.subplots()
ax.scatter(Blx, Bly, color='blue', marker='s', label='Linear: $\lVert e\\rVert_{L_{2}}=0.75h^{1.10}$')
ax.scatter(Bqx, Bqy, color='red', marker='o', facecolor='none', label='Quadratic: $\lVert e\\rVert_{L_{2}}=0.15h^{1.37}$')
