...
if __name__ == '__main__':
    ...
    arguments = np.array([
        "validation_FEM('Estar', 'FEM_70deg', 'Exp', 10)",
        "validation_FEM('Estar', 'FEM_70deg', 'Exp', 70)",
        "validation_FEM('sigma_y', 'FEM_70deg', 'Exp', 10)",
        "validation_FEM('sigma_y', 'FEM_70deg', 'Exp', 70)"
        ])
