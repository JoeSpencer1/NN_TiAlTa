...
def validation_two(yname, train_size, trainlow, trainhigh, testname):
    ...
    with open('Output.txt', 'a') as f:
        f.write('validation_two ' + yname + ' ' + str(train_size) + ' ' + str(np.mean(mape, axis=0)) + ' ' + str(np.std(mape, axis=0)) + ' ' + testname + ' ' + trainlow + ' ' + trainhigh + '\n')
    print(mape)
...
def validation_three(yname, train_size, trainlow, trainhigh, trainexp, testname):
    ...
    with open('output.txt', 'a') as f:
        f.write('validation_three ' + yname + ' ' + str(train_size) + ' ' + str(np.mean(ape, axis=0)) + ' ' + str(np.std(ape, axis=0)) + ' ' + testname + ' ' + trainlow + ' ' + trainhigh + ' ' + trainexp + '\n')
