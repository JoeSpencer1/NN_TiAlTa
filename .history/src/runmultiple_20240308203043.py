...
if __name__ == '__main__':
    ...
    arguments = np.array([
        "validation_three('Er', 0, 'Lu et al/B3090', 'Lu et al/B3090', 'Lu et al/Berkovich', 'Lu et al/FEM_70deg')",
        "validation_three('Er', 20, 'Lu et al/B3090', 'Lu et al/B3090',  'Lu et al/Berkovich', 'Lu et al/FEM_70deg')",
        "validation_three('sigma_y', 0, 'Lu et al/B3090', 'Lu et al/B3090', 'Lu et al/Berkovich', 'Lu et al/FEM_70deg')",
        "validation_three('sigma_y', 20, 'Lu et al/B3090', 'Lu et al/B3090', 'Lu et al/Berkovich', 'Lu et al/FEM_70deg')"
        ])
