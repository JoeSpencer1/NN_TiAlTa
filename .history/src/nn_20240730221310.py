...
def find_properties(pname, expname, train_hi, train_lo, lay=2, wid=128):
    datalow = FileData(train_lo, pname)
    datahigh = FileData(train_hi, pname)
    dataexp = FileData(expname, pname, new=True)
