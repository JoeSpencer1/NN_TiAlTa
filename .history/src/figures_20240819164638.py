...
ax.scatter(df['disp_y_3D'], df['react_y_3D']*6, color='blue', marker='.', zorder=2, label='3D model')
...
ax.scatter(df['disp_y_2D']*1000, df['react_y_2D'], color='red', marker='*', zorder=3, s = 10, label='2D model')
