...
# 3D quad elements
n_3Dq = [5, 10, 15, 20]
l2dσ = [948.6102, 693.94135, 587.1541, 714.6778]
εl2dσ = [1352.8092, 226.60805, 343.06134, 514.5537]
l2dE = [193.163, 246.93584, 169.33572, 153.87508]
εl2dE = [75.74496, 68.1138, 67.68839, 52.5883]
# Experimental data
n_exp = [5, 10, 15, 20]
