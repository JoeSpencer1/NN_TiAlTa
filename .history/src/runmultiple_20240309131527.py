...
if __name__ == '__main__':
    ...
    arguments = np.array([
        ...
        "validation_two('Er', 2, 'Lu et al/B3090', 'Lu et al/Berkovich', 'Lu et al/FEM_70deg')",
        "validation_two('Er', 12, 'Lu et al/B3090', 'Lu et al/Berkovich', 'Lu et al/FEM_70deg')",
        "validation_two('sigma_y', 2, 'Lu et al/B3090', 'Lu et al/Berkovich', 'Lu et al/FEM_70deg')",
        "validation_two('sigma_y', 12, 'Lu et al/B3090', 'Lu et al/Berkovich', 'Lu et al/FEM_70deg')",
        ])
