...
if __name__ == '__main__':
    ...
    arguments = np.array([
        "validation_one('Er', 'Lu et al/B3090', 'Lu et al/B3090', 5, n_vd=0)",
        "validation_one('sigma_y', 'Lu et al/B3090', 'Lu et al/B3090', 5, n_vd=0)",
        "validation_one('Er', 'Lu et al/B3090', 'Lu et al/B3090', 20, n_vd=0)",
        "validation_one('sigma_y', 'Lu et al/B3090', 'Lu et al/B3090', 20, n_vd=0)",
        "validation_one('Er', 'Lu et al/B3090', 'Lu et al/B3090', 100, n_vd=0)",
        "validation_one('sigma_y', 'Lu et al/B3090', 'Lu et al/B3090', 100, n_vd=0)"
        ])
