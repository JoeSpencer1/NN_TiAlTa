...
if __name__ == '__main__':
    ...
    arguments = np.array([
        "validation_two('Estar', 1, 'Al6061', 'FEM', 'Berk', lay=2)",
        "validation_two('Estar', 5, 'Al6061', 'FEM', 'Berk', lay=2)",
        "validation_two('sigma_y', 1, 'Al6061', 'FEM', 'Berk', lay=2)",
        "validation_two('sigma_y', 5, 'Al6061', 'FEM', 'Berk', lay=2)"
        ])
