...
εquadσ = [198.4
60.71, 32.85, 25.92, 42.98, 17.2, 29.49, 22.21]
quadE = [148.56
47.97, 24.67, 18.92, 15.01, 6.97, 5.99, 2.86]
εquadE = [225.48
47.25, 20.73, 14.04, 10.13, 4.31, 4.14, 3.95]
# Linear
linσ = [2442.06
123.75, 131.23, 64.36, 41.86, 48.24, 47.69, 143.44]
εlinσ = [5165.55
121.11, 116.49, 40.47, 38.56,56.27, 98.03, 208.49]
linE = [756.26
39.38, 42.67, 15.69, 12.98, 7.54, 5.43, 10.7]
εlinE = [1567.03
50.9, 18.97, 14.32, 11.65, 12.1, 7.56, 14.37]
# Rough quadratic
rqσ = [413.5
58.08, 18.11, 28.25, 11.46, 7.36, 3.89, 2.45]
εrqσ = [815.19
79.78, 16.59, 36.32, 5.59, 3.37, 2.83, 3.53]
rqE = [37.33
1.2
30.03
257.9
...
5.9
4.21
3.32, 1.78, 2.04, 1.53, 1.32, 0.41]
εrlE = [9.95
4.12, 6.2, 2.25, 1.25, 1.95, 1.1, 1.19, 0.29]
...
# Quad
quadσ = [1361.85
863.64, 123.4, 126.98, 72.64, 60.89, 59.13, 32.84, 13.14]
εquadσ = [1111.76
1540.86, 50.87, 65.35, 22.83, 20.09, 27.33, 21.3, 11.13]
quadE = [65.44
34.84, 38.36, 21.29, 11.58, 8.96, 5.74, 4.96, 3.39]
εquadE = [51.47
32.09, 69.16, 24.89, 6.36, 4.36, 2.89, 5.12, 1.63]
# Linear
linσ = [1723.27
221, 53.92, 54.41, 83.75, 23.93, 25.42, 23.64, 13.26]
εlinσ = [1685.46
228.88, 30.26, 25.8, 117.77, 12.7, 27.64, 14.13, 11.15]
linE = [80.47
15.82, 7.7, 11.13, 6.26, 3.17, 2.25, 2.8, 2.89]
εlinE = [113.42
12.53, 8.1, 12.09, 3.01, 1.69, 1.77, 2.79, 5.28]
# Rough quadratic
rqσ = [14618
10.57, 3.33, 1.94, 1.36, 1, 1.07, 0.73, 0.66]
εrqσ = [37534.82
13.1, 3.41, 1.87, 0.62, 0.38, 0.61, 0.31, 0.23]
rqE = [0.83
32.76, 0.53, 0.24, 0.26, 0.23, 0.14, 0.1, 0.12]
εrqE = [0.49
31.93, 0.59, 0.2, 0.15, 0.2, 0.11, 0.05, 0.06]
# Rough linear
rlσ = [2382.1
2.93, 1.81, 1.12, 0.91, 0.96, 0.81, 0.73, 0.68]
εrlσ = [1759.34
2.29, 1.25, 0.94, 0.63, 0.33, 0.44, 0.43, 0.55]
rlE = [18.97
0.3, 0.19, 0.14, 0.16, 0.11, 0.1, 0.05, 0.06]
εrlE = [13.92
0.23, 0.22, 0.09, 0.21, 0.06, 0.04, 0.03, 0.03]
...
ax1.set_xlim([-0.5, 16])
ax1.set_xticks([0, 5, 10, 15])
ax1.set_yticks([1, 20, 200, 1000, 3000])
ax1.set_yticklabels([1, 20, 200, 1000, 3000])
ax1.legend()
ax1.set_ylabel("MAPE (%)")
ax1.set_xlabel("Experimental training data size")
ax1.annotate("A: $\sigma_{y}$", xy=(0.05, 0.95), xycoords="axes fraction",
