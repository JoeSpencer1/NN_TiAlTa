...
for i in range(len(x1)):
    ...
    for axis in [x1, y1, z1]:
        for i in range(len(axis)):
            if axis[i] % maxh != 0:
                fac /= 2
            if axis is x1 or axis is y1 and axis[i] in (-1.5, 1.5):
                fac /= 2
            if axis.equals(z1) and axis[i] in (-1.5, 1.5):
                fac /= 2
...
print('p2=', np.log(e1/e3)/np.log(4))
...
for i in range(len(x1)):
    ...
    for axis in [x1, y1, z1]:
        for i in range(len(axis)):
            if axis[i] % maxh != 0:
                fac /= 2
            if axis.equals(x1) or axis.equals(y1) and axis[i] in (-1.5, 1.5):
                fac /= 2
            if axis.equals(z1) and axis[i] in (-1.5, 1.5):
                fac /= 2
...
print('e2=', e2)
print('e3=', e3)
print('p=', np.log(e1/e3)/np.log(8))
print('C=', np.average([e1/maxh**(np.log(e1/e4)/np.log(8)), e2/(maxh/2)**(np.log(e1/e4)), e3/(maxh/2)**(np.log(e1/e4)/np.log(8))]))
