...
fig, ax = plt.subplots()
ax.scatter(C30x, C30y, color='blue', marker='s', label='30˚: $||e||_{L_{2}}=2.30h^{2.183}$')
ax.scatter(C45x, C45y, color='red', marker='o', facecolor='none', label='45˚: $||e\rVert_{L_{2}}=14.42h^{2.40}$')
ax.scatter(C60x, C60y, color='green', marker='x', label='60˚: $||e||_{L_{2}}=9.60h^{1.95}$')
ax.scatter(C70x, C70y, color='black', marker='^', label='70.3˚: $||e||_{L_{2}}=9.60h^{1.95}$')
