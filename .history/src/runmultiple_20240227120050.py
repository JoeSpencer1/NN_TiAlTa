...
if __name__ == '__main__':
    ...
    arguments = np.array([
        "validation_two('sigma_y', 5, 'B3090', 'B3090', 'Berkovich')",
        "validation_two('Estar', 5, 'B3090', 'B3090', 'Berkovich')",
        "validation_two('sigma_y', 10, 'B3090', 'B3090', 'Berkovich')",
        "validation_two('Estar', 10, 'B3090', 'B3090', 'Berkovich')",
        "validation_two('sigma_y', 15, 'B3090', 'B3090', 'Berkovich')",
        "validation_two('Estar', 15, 'B3090', 'B3090', 'Berkovich')",
        "validation_two('sigma_y', 20, 'B3090', 'B3090', 'Berkovich')",
        "validation_two('Estar', 20, 'B3090', 'B3090', 'Berkovich')",
        "validation_two('sigma_y', 25, 'B3090', 'B3090', 'Berkovich')",
        "validation_two('Estar', 25, 'B3090', 'B3090', 'Berkovich')",
        "validation_two('sigma_y', 30, 'B3090', 'B3090', 'Berkovich')",
        "validation_two('Estar', 30, 'B3090', 'B3090', 'Berkovich')"
        ])
