...
fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(12, 5))
ax1.errorbar(n, quadσ, yerr = εquadσ, color = 'blue', label = "MFNN, quadratic 3D FEM + experimental training data")
...
fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(12, 5))
ax1.errorbar(n, quadσ, yerr = εquadσ, color = 'blue', label = "MFNN, quadratic 2D FEM + experimental training data")
...
fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(12, 5))
ax1.errorbar(n, quadσ, yerr = εquadσ, color = 'blue', label = "MFNN, quadratic FEM high training")
ax1.errorbar(n, linσ, yerr = εlinσ, color = 'darkorange', linestyle = '--', label = "MAPE, linear FEM + experiment")
ax1.errorbar(n, rqσ, yerr = εrqσ, color = 'red', linestyle = '-.', label = "MAPE, rough quadratic FEM + experiment")
ax1.errorbar(n, rlσ, yerr = εrlσ, color = 'green', linestyle = ':', label = "MAPE, rough linear FEM + experiment")
ax1.set_yscale('log')
...
fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(12, 5))
ax1.errorbar(n, quadσ, yerr = εquadσ, color = 'blue', label = "MFNN, quadratic FEM low training")
ax1.errorbar(n, linσ, yerr = εlinσ, color = 'darkorange', linestyle = '--', label = "MAPE. linear FEM training data")
...
ax1.set_yticklabels([1, 10, 50, 200, 1000])
ax1.legend()
ax1.set_ylabel("MAPE (%)")
ax1.set_xlabel("Experimental training data size")
ax1.annotate("A: $\sigma_{y}$", xy=(0.05, 0.95), xycoords="axes fraction",
