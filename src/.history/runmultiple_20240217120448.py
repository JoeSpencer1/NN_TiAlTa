...
if __name__ == '__main__':
    ...
    arguments = np.array([
        "validation_mf('sigma_y', 1, 'FEM_70deg', 'B3090', 'B3090')",
        "validation_mf('Estar', 1, 'FEM_70deg', 'B3090', 'B3090')",
        "validation_mf('sigma_y', 2, 'FEM_70deg', 'B3090', 'B3090')",
        "validation_mf('Estar', 2, 'FEM_70deg', 'B3090', 'B3090')",
        "validation_mf('sigma_y', 3, 'FEM_70deg', 'B3090', 'B3090')",
        "validation_mf('Estar', 3, 'FEM_70deg', 'B3090', 'B3090')",
        "validation_mf('sigma_y', 4, 'FEM_70deg', 'B3090', 'B3090')",
        "validation_mf('Estar', 4, 'FEM_70deg', 'B3090', 'B3090')",
        "validation_mf('sigma_y', 5, 'FEM_70deg', 'B3090', 'B3090')",
        "validation_mf('Estar', 5, 'FEM_70deg', 'B3090', 'B3090')",
