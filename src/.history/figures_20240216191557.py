...
ax1.errorbar(n_me, meσ, yerr = εmeσ, color = 'red', linestyle=':', label = "My replication (70.3˚)")
ax1.set_yscale('linear')
ax1.set_ylim([0, 150])
ax1.set_xlim([-0.5, 90])
...
ax2.errorbar(n_me, meE, yerr = εmeE, color = 'red', linestyle=':', label = "My replication (n$_{tr}$=100)")
ax2.set_yscale('linear')
ax2.set_ylim([0, 16])
ax2.set_xlim([-0.5, 90])
