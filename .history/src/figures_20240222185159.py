...
ax1.errorbar(n_b60, b60σ, yerr = εb60σ, linestyle = ':', color = 'brown', label = "coarse mesh 60˚")
ax1.set_yscale('log')
...
ax2.errorbar(n_a60, a70E, yerr = εa70E, color = 'green', label = "60˚ (n$_{tr}$=58)")
ax2.errorbar(n_a60, a70E, yerr = εa70E, linestyle = ':',, color = 'brown', label = "coarse 60˚ (n$_{tr}$=17)")
ax2.set_yscale('log')
