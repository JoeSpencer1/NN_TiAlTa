...
if __name__ == '__main__':
    ...
    arguments = np.array([
        "validation_one('sigma_y', 10, 'Berkovich', 'Berkovich')",
        "validation_one('Estar', 10, 'Berkovich', 'Berkovich')",
        "validation_one('sigma_y', 10, 'FEM_70deg', 'FEM_70deg')",
        "validation_one('Estar', 10, 'FEM_70deg', 'FEM_70deg')",
        "validation_one('sigma_y', 10, 'B3090', 'B3090')",
        "validation_one('Estar', 10, 'B3090', 'B3090')"
        ])
