...
εmeσ = [177.584915, 27.026743, 13.707746, 5.507115, 9.828185, 6.028146, 6.7208185, 8.7345]
...
ax1.errorbar(n_lu, luσ, yerr = εluσ, color = 'red', linestyle=':', label = "My replication (70.3˚)")
ax1.set_yscale('linear')
ax1.set_ylim([0, 150])
ax1.set_xlim([-0.5, 90])
...
ax2.errorbar(n_lu, luE, yerr = εluE, color = 'red', linestyle=':', label = "My replication (n$_{tr}$=100)")
ax2.set_yscale('linear')
ax2.set_ylim([0, 16])
ax2.set_xlim([-0.5, 90])
