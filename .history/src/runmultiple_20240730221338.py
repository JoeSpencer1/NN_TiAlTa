...
if __name__ == '__main__':
    run_processes(np.array([
        "find_properties('n', 'B3067', ('B3067', 'B3090', 'Al6061', 'Al7075', 'Lu_Berkovich'), 'Lu_conical', lay=2, wid=128)",
        "find_properties('n', 'TI33_25', ('B3067', 'B3090', 'Al6061', 'Al7075', 'Lu_Berkovich'), 'Lu_conical', lay=2, wid=128)"
...
#        "validation_three('Er', 'TI33_25', 'TI33_25', 15, '3D_quad', 15, '2D_70_quad', 15, typ='hi')"
    ...
    run_processes(np.array([
        "validation_three('sy', 'TI33_25', 'TI33_25', 0, '3D_quad', 0, '2D_70_quad', 0, typ='lo')",
        "validation_three('sy', 'TI33_25', 'TI33_25', 1, '3D_quad', 1, '2D_70_quad', 1, typ='lo')",
        "validation_three('sy', 'TI33_25', 'TI33_25', 2, '3D_quad', 2, '2D_70_quad', 2, typ='lo')",
        "validation_three('sy', 'TI33_25', 'TI33_25', 3, '3D_quad', 3, '2D_70_quad', 3, typ='lo')",
        "validation_three('sy', 'TI33_25', 'TI33_25', 4, '3D_quad', 4, '2D_70_quad', 4, typ='lo')",
        "validation_three('sy', 'TI33_25', 'TI33_25', 5, '3D_quad', 5, '2D_70_quad', 5, typ='lo')",
        "validation_three('sy', 'TI33_25', 'TI33_25', 6, '3D_quad', 6, '2D_70_quad', 6, typ='lo')",
        "validation_three('sy', 'TI33_25', 'TI33_25', 8, '3D_quad', 8, '2D_70_quad', 8, typ='lo')",
        "validation_three('sy', 'TI33_25', 'TI33_25', 10, '3D_quad', 10, '2D_70_quad', 10, typ='lo')",
        "validation_three('sy', 'TI33_25', 'TI33_25', 15, '3D_quad', 15, '2D_70_quad', 15, typ='lo')"
        ]))
    run_processes(np.array([
