...
ax2.errorbar(n_Ex, ExE, yerr = εExE, color = 'green', label = "B3090 data (n$_{tr}$=100)")
ax2.set_yscale('linear')
ax2.set_ylim([0, 80])
ax2.set_xlim([-0.5, 24])
...
ax2.errorbar(n_lua, meluE, yerr = εmeluE, color = 'green', label = "Lu's data (n$_{tr}$=100)")
ax2.set_yscale('log')
ax2.set_ylim([0, 20])
ax2.set_xlim([-0.5, 21])
ax2.set_xticks([0, 5, 10, 15, 20])
...
n_lua = [1, 2, 3, 4, 5, 6, 8, 10, 20]
meluσ = [34.76187049381707, 15.666057266762687, 6.996018572793789, 5.247694673209859, 4.675818271982714, 2.8224066143898994, 1.7193101447336872, 1.1601397290108126]
εmeluσ = [10.740497950208871, 11.320466708732308, 3.6585756140059877, 2.428309380448281, 1.830393016684322, 0.7991033526928624, 0.5419118098670546, 0.6601813023072108]
meluE = [6.277749365665346, 1.8816316858388151, 1.6219183265376143, 1.557228150514812, 1.2657623943780592, 1.123555123730203, 1.1112026038692304, 0.9507400282322637]
εmeluE = [6.320663598962627, 0.5880917816388127, 0.5585803534905526, 0.4803461648995692, 0.47507417407693564, 0.1597705074954198, 0.1597705074954198, 0.0680595017707608]
