...
if __name__ == '__main__':
    ...
    arguments = np.array([
        "validation_FEM_unedited('Estar', [70], 10)",
        "validation_FEM_unedited('Estar', [70], 20)",
        "validation_FEM_unedited('Estar', [70], 30)",
        "validation_FEM_unedited('Estar', [70], 40)",
        "validation_FEM_unedited('Estar', [70], 50)",
        "validation_FEM_unedited('Estar', [70], 60)",
        "validation_FEM_unedited('Estar', [70], 70)",
        "validation_FEM_unedited('Estar', [70], 80)",
        "validation_FEM_unedited('sigma_y', [70], 10)",
        "validation_FEM_unedited('sigma_y', [70], 20)",
        "validation_FEM_unedited('sigma_y', [70], 30)",
        "validation_FEM_unedited('sigma_y', [70], 40)",
        "validation_FEM_unedited('sigma_y', [70], 50)",
        "validation_FEM_unedited('sigma_y', [70], 60)",
        "validation_FEM_unedited('sigma_y', [70], 70)",
        "validation_FEM_unedited('sigma_y', [70], 80)"
        ])
