...
ax1.errorbar(n, rqσ, yerr = εrqσ, color = 'red', linestyle = '-.', label = "MAPE, rough quadratic FEM training data")
ax1.errorbar(n, rlσ, yerr = εrlσ, color = 'green', linestyle = ':', label = "MAPE, rough linear FEM training data")
ax1.set_yscale('log')
ax1.set_ylim([0.5, 1000])
ax1.set_xlim([-0.5, 16])
ax1.set_xticks([0, 5, 10, 15])
