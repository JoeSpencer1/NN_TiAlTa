...
print('e4=', e4)
print('e5=', e5)
print('p=', np.log(e1/e5)/np.log(16))
print('p1=', np.log(e2/e5)/np.log(8))
print('p2=', np.log(e1/e4)/np.log(8))
print('p5=', np.log(e3/e5)/np.log(4))
print('p4=', np.log(e2/e4)/np.log(4))
print('p3=', np.log(e1/e3)/np.log(4))
...
print('e4=', e4)
print('p=', np.log(e1/e4)/np.log(8))
print('p1=', np.log(e2/e4)/np.log(4))
print('p5=', np.log(e3/e5)/np.log(4))
print('p3=', np.log(e1/e3)/np.log(4))
print('C=', np.average([e1/maxh**(np.log(e1/e4)/np.log(8)), e2/(maxh/2)**(np.log(e1/e4)/np.log(8)), e3/(maxh/4)**(np.log(e1/e4)/np.log(8)), e4/(maxh/8)**(np.log(e1/e4)/np.log(8))]))
...
x1, y1, z1 = df['X2 (m)'], df['Y2 (m)'], df['Z2 (m)']
x2, y2, z2 = df['X3 (m)'], df['Y3 (m)'], df['Z3 (m)']
x3, y3, z3 = df['X4 (m)'], df['Y4 (m)'], df['Z4 (m)']
x4, y4, z4 = df['X5 (m)'], df['Y5 (m)'], df['Z5 (m)']
x5, y5, z5 = df['X5 (m)'], df['Y5 (m)'], df['Z5 (m)']
D1, D2, D3, D4, D5 = df['D2 (m)'], df['D3 (m)'], df['D4 (m)'], df['D5 (m)'], df['D5 (m)']
df['r2'], df['r3'], df['r4'], df['r5'] = np.full((len(df['X1 (m)']),), 100), np.full((len(df['X1 (m)']),), 100), np.full((len(df['X1 (m)']),), 100), np.full((len(df['X1 (m)']),), 100)
df['err2'], df['err3'], df['err4'], df['err5'] = df['X1 (m)'], df['X1 (m)'], df['X1 (m)'], df['X1 (m)']
...
print('e3=', e3)
print('p=', np.log(e1/e3)/np.log(4))
print('C=', np.average([e1/maxh**(np.log(e1/e4)/np.log(4)), e2/(maxh/2)**(np.log(e1/e4)/np.log(4)), e3/(maxh/4)**(np.log(e1/e4)/np.log(4))]))
...
x4, y4, z4 = df['X4 (m)'], df['Y4 (m)'], df['Z4 (m)']
x5, y5, z5 = df['X5 (m)'], df['Y5 (m)'], df['Z5 (m)']
D1, D2, D3, D4, D5 = df['D2 (m)'], df['D3 (m)'], df['D4 (m)'], df['D4 (m)'], df['D5 (m)']
df['r2'], df['r3'], df['r4'], df['r5'] = np.full((len(df['X1 (m)']),), 100), np.full((len(df['X1 (m)']),), 100), np.full((len(df['X1 (m)']),), 100), np.full((len(df['X1 (m)']),), 100)
df['err2'], df['err3'], df['err4'], df['err5'] = df['X1 (m)'], df['X1 (m)'], df['X1 (m)'], df['X1 (m)']
...
x1, y1, z1 = df['X3 (m)'], df['Y3 (m)'], df['Z3 (m)']
x2, y2, z2 = df['X4 (m)'], df['Y4 (m)'], df['Z4 (m)']
x3, y3, z3 = df['X5 (m)'], df['Y5 (m)'], df['Z5 (m)']
x4, y4, z4 = df['X4 (m)'], df['Y4 (m)'], df['Z4 (m)']
x5, y5, z5 = df['X5 (m)'], df['Y5 (m)'], df['Z5 (m)']
D1, D2, D3, D4, D5 = df['D3 (m)'], df['D4 (m)'], df['D5 (m)'], df['D4 (m)'], df['D5 (m)']
df['r2'], df['r3'], df['r4'], df['r5'] = np.full((len(df['X1 (m)']),), 100), np.full((len(df['X1 (m)']),), 100), np.full((len(df['X1 (m)']),), 100), np.full((len(df['X1 (m)']),), 100)
df['err2'], df['err3'], df['err4'], df['err5'] = df['X1 (m)'], df['X1 (m)'], df['X1 (m)'], df['X1 (m)']
