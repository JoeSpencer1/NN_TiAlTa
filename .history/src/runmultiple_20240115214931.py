...
if __name__ == '__main__':
    ...
    arguments = np.array([
        "validation_three('Estar', 1, 'TI33_25', 'TI33_250')",
        "validation_three('Estar', 20, 'TI33_25', 'TI33_250')",
        "validation_three('sigma_y', 1, 'TI33_25', 'TI33_250')",
        "validation_three('sigma_y', 20, 'TI33_25', 'TI33_250')"
        ])
