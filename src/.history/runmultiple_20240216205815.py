...
if __name__ == '__main__':
    ...
    arguments = np.array([
        ...
        "validation_mf('sigma_y', 40, 'Berkovich', 'B3090', 'B3090')",
        "validation_mf('Estar', 40, 'Berkovich', 'B3090', 'B3090')",
        "validation_mf('sigma_y', 50, 'Berkovich', 'B3090', 'B3090')",
        "validation_mf('Estar', 50, 'Berkovich', 'B3090', 'B3090')",
        "validation_mf('sigma_y', 60, 'Berkovich', 'B3090', 'B3090')",
        "validation_mf('Estar', 60, 'Berkovich', 'B3090', 'B3090')",
        "validation_mf('sigma_y', 70, 'Berkovich', 'B3090', 'B3090')",
        "validation_mf('Estar', 70, 'Berkovich', 'B3090', 'B3090')"
        ])
