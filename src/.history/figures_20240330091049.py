...
ax1.errorbar(n, roughσ, yerr = εroughσ, color = 'magenta', linestyle = '.-', label = "MAPE with rough FEM training data")
ax1.set_yscale('log')
ax1.set_ylim([2, 3000])
ax1.set_xlim([-0.5, 16])
ax1.set_xticks([0, 5, 10, 15])
...
ax2.errorbar(n, roughE, yerr = εroughE, color = 'magenta', linestyle = '.-')
ax2.set_yscale('log')
ax2.set_ylim([1, 150])
ax2.set_xlim([-0.5, 16])
ax2.set_xticks([0, 5, 10, 15])
