...
if __name__ == '__main__':
    ...
    arguments = np.array([
        "validation_two('Estar', 0, 'B3090', 'FEM', 'Exp', lay=2)",
        "validation_two('Estar', 5, 'B3090', 'FEM', 'Exp', lay=2)",
        "validation_two('Estar', 20, 'B3090', 'FEM', 'Exp', lay=2)",
        "validation_two('sigma_y', 0, 'B3090', 'FEM', 'Exp', lay=2)",
        "validation_two('sigma_y', 5, 'B3090', 'FEM', 'Exp', lay=2)",
        "validation_two('sigma_y', 20, 'B3090', 'FEM', 'Exp', lay=2)",
        ])
