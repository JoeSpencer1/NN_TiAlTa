...
if __name__ == '__main__':
    ...
    arguments = np.array([
        ...
        "validation_FEM('sigma_y', 'FEM_70deg', 20)",
        "validation_FEM('sigma_y', 'FEM_70deg', 30)",
        "validation_FEM('sigma_y', 'FEM_70deg', 40)",
        "validation_FEM('sigma_y', 'FEM_70deg', 50)",
        "validation_FEM('sigma_y', 'FEM_70deg', 60)",
        "validation_FEM('sigma_y', 'FEM_70deg', 70)",
        "validation_FEM('sigma_y', 'FEM_70deg', 'FEM_70deg',10)",
        "validation_FEM('Estar', 'FEM_70deg', 10)",
        "validation_FEM('Estar', 'FEM_70deg', 20)",
        "validation_FEM('Estar', 'FEM_70deg', 30)",
        "validation_FEM('Estar', 'FEM_70deg', 40)",
        "validation_FEM('Estar', 'FEM_70deg', 50)",
        "validation_FEM('Estar', 'FEM_70deg', 60)",
        "validation_FEM('Estar', 'FEM_70deg', 70)",
        "validation_FEM('Estar', 'FEM_70deg', 80)"
        ])
