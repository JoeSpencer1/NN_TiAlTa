...
# # 2D linear case
# maxh = 0.2
# df = pd.read_csv('../moose/outputs/convergence/conv_2D_l.csv')
# print(df)

# x1, y1, z1 = df['x1'], df['y1'], df['z1']
# x2, y2, z2 = df['x2'], df['y2'], df['z2']
# x3, y3, z3 = df['x3'], df['y3'], df['z3']
# D1, D2, D3 = df['d1'], df['d2'], df['d3']
# df['r2'], df['r3'] = np.full((len(df['x1']),), 100), np.full((len(df['x1']),), 100)
# df['err2'], df['err3'] = df['x1'], df['x1']
...
#             fac /= 2
#         if axis.equals(y1) and axis[i] in (-2, 0):
#             fac /= 2
...
# # 2D Quadratic case
# maxh = 0.2
# df = pd.read_csv('../moose/outputs/convergence/conv_2D_q.csv')
# print(df)
