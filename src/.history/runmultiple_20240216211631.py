...
if __name__ == '__main__':
    ...
    arguments = np.array([
        "validation_mf('sigma_y', 30, 'FEM_70deg', 'B3090', 'B3090')",
        "validation_mf('Estar', 30, 'FEM_70deg', 'B3090', 'B3090')",
        "validation_mf('sigma_y', 30, 'Berkovich', 'B3090', 'B3090')",
        "validation_mf('Estar', 30, 'Berkovich', 'B3090', 'B3090')"
        ])
